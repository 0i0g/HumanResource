...
namespace Data_EF.Migrations
{
    ...
    [Migration("20210306072948_Update OT request Date range2")]
    partial class UpdateOTrequestDaterange2
    {
            ...
            modelBuilder.Entity("Data.Entities.AppSystem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bf807616-a770-4bb3-90ae-8f97ddcbf076"),
                            Code = "T1",
                            CreatedAt = new DateTime(2021, 3, 6, 14, 29, 47, 378, DateTimeKind.Utc).AddTicks(175),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            Name = "Default System",
                            UpdatedAt = new DateTime(2021, 3, 6, 14, 29, 47, 378, DateTimeKind.Utc).AddTicks(1240),
            ...
            modelBuilder.Entity("Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("16efa5d0-985d-475f-9fbf-028074fc77b6"),
                        ...
                        new
                        {
                            Id = new Guid("44052829-10ef-468c-aab8-692f3544cff2"),
                            ActivatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            Role = 3,
                            SystemId = new Guid("bf807616-a770-4bb3-90ae-8f97ddcbf076"),
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Username = "emp"
                        },
                        new
                        {
                            Id = new Guid("ce0f7fcf-6b5f-4ab0-91a0-0d2b7318c33f"),
                            ActivatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("98e4a966-d7eb-41a3-9963-3107565e7119"),
                            ActivatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
